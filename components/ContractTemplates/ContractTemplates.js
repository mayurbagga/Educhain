                                        ...
                                        <>
                                            ...
                                            >
                                                ...
                                                <h3 className="title w-600 mb--10">
                                                    Discover wide range of pre written contracts
                                                </h3>
                                                <p className="description b3">
                                                    You can have access of wide range of contracts tha are ready to deploy
                                                    <br />
                                                    and with our Web3Agent you can deploy it instantly to any chain
                                                </p>
                                            </div>
                                        </>
                                    }
