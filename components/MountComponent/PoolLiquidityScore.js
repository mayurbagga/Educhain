...
export const PoolLiquidityScore = ({ data: action }) => {
    ...
    useEffect(() => {
        ...
        var ctx = document?.getElementById(action.id + "doughnutChartPool")?.getContext("2d");
        ...
        var barCtx = document?.getElementById(action.id + "barChartPool")?.getContext("2d");
                            ...
                            >
                                <div className="row align-items-center" style={{ height: "100%" }}>
                                    <div className="col-6" style={{ height: "100%" }}>
                                        <canvas id={`${action.id}doughnutChartPool`}></canvas>
                                    </div>
                                    <div className="col-6">
                                        <canvas id={`${action.id}barChartPool`} style={{ height: "100%" }}></canvas>
                                    </div>
                                </div>
                            </div></>
                        :
