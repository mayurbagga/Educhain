...
import { TopTrendingTokens } from './TopTrendingTokens';
import TopLatestNews from './TopLatestNews';
...
export default function MountComponent({ data }) {
  ...
  const renderActionComponent = () => {
    switch (name) {
      ...
      case 'TOP_TRENDING_TOKENS':
        return <TopTrendingTokens data={ componentData } />;
      case 'TOP_LATEST_NEWS':
        // return <TopLatestNews data={ componentData } />;
        return <h1>top latestnews</h1>;
      default:
        return '';
    }
  };
