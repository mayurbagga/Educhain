...
import HookContractBuilder from "@/components/HookBuilder/HookContractBuilder";
// import HookContractBuilder from "@/components/ContractBuilders/HookContractBuilder";
      ...
      <main className="page-wrapper rbt-dashboard-page">
        <Context>
          <div className="rbt-panel-wrapper">
            ...
            <HookContractBuilder id={id} initialMessages={initialMessages} />
          </div>
        </Context>
      </main>
    </>
