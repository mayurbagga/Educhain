...
import { mainnet, mode, modeTestnet,sepolia, bsc, bscTestnet, arbitrum, arbitrumGoerli, arbitrumSepolia, base, baseSepolia, optimism, optimismSepolia } from "wagmi/chains";
...
export const config = getDefaultConfig({
  ...
  chains: [mode, modeTestnet,  bsc, bscTestnet,  base, baseSepolia, optimism, optimismSepolia, mainnet, sepolia],
  ssr: true,
});
